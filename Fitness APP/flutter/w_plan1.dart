...
import 'package:testt/w_plan2.dart';
import 'package:testt/leg.dart';
import 'package:testt/pullwork.dart';
import 'package:testt/pushwork.dart';
...
class w_plan1 extends StatefulWidget {
  late String email;
  ...
  @override
  State<w_plan1> createState() => _w_plan1();
}

late String h;

class _w_plan1 extends State<w_plan1> {
  int selectedindex = 1;
        ...
        decoration: BoxDecoration(
          image: DecorationImage(
            ...
            colorFilter: ColorFilter.mode(
                Color.fromARGB(255, 27, 28, 57).withOpacity(0.3),
                BlendMode.darken),
    ...
    return SingleChildScrollView(
      ...
      Container(
        ...
        child: ListTile(
          ...
          onTap: () {
            Navigator.push(
                context, MaterialPageRoute(builder: (context) => pushwork(h)));
          },
        ),
      ),
      Container(
        ...
        child: ListTile(
          ...
          onTap: () {
            Navigator.push(
                context, MaterialPageRoute(builder: (context) => pullwork(h)));
          },
        ),
      ),
      Container(
        ...
        child: ListTile(
          ...
          onTap: () {
            Navigator.push(
                context, MaterialPageRoute(builder: (context) => legwork(h)));
          },
        ),
      ),
      Container(
      ...
      MaterialButton(
        ...
        onPressed: () {
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => w_plan2(w_plan2(h).email)));
        },
