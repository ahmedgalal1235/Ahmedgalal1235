...
class pullwork extends StatefulWidget {
  late String email;
  ...
  @override
  State<pullwork> createState() => _pullwork();
}
late String v;
...
class _pullwork extends State<pullwork> {
  List list = [];
  Future getdata() async {
    var url = "https://fitnessapplication111.000webhostapp.com/project/fun/workout/pullwork.php";
...
,Container(height: 20,)
          ...
          fontSize: 16.0);
                                                              Navigator.push(context, MaterialPageRoute(builder: (context) => w_plan1(w_plan1(h).email)));
