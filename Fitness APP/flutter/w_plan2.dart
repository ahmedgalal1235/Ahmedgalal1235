...
import 'package:testt/workout.dart';
...
class w_plan2 extends StatefulWidget {
  late String email;
  ...
  @override
  State<w_plan2> createState() => _w_plan2();
}

late String h;

class _w_plan2 extends State<w_plan2> {
  int selectedindex = 1;
        ...
        decoration: BoxDecoration(
          image: DecorationImage(
            ...
            colorFilter: ColorFilter.mode(
                Color.fromARGB(255, 29, 31, 63).withOpacity(0.3),
                BlendMode.darken),
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      ...
      Container(
        ...
        child: ListTile(
          title:
              Text("Full body workout", style: TextStyle(color: Colors.white)),
          subtitle: Text("all body muscles",
          ...
          onTap: () {
            Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => workout(w_plan2(h).email)));
          },
        ),
      ),
      Container(
      ...
      MaterialButton(
        ...
        onPressed: () {
          Navigator.push(context,
              MaterialPageRoute(builder: (context) => home(w_plan2(h).email)));
        },
