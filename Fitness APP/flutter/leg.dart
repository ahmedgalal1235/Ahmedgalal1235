...
class legwork extends StatefulWidget {
  late String email;
  ...
  @override
  State<legwork> createState() => _legwork();
}
...
class _legwork extends State<legwork> {
  List list = [];
  Future getdata() async {
    var url = "https://fitnessapplication111.000webhostapp.com/project/fun/workout/legwork.php";
