...
class _workoutState extends State<workout> {
  ...
  Future getdata() async {
    var url = "https://fitnessapplication111.000webhostapp.com/project/fun/workout/fullwork.php";
...
,Container(height: 20,)
                  ...
                  Row(
                    children: [
                      ...
                      Container(
                        margin: EdgeInsets.only(bottom: 12),
                        child:
                            Text("${list[7]["reps"]}", style: TextStyle(color: Colors.white)),
                      ),
                      Container(
                        margin: EdgeInsets.only(bottom: 12),
                        child: Text(" Sets: ",
                      ...
                      Container(
                        margin: EdgeInsets.only(bottom: 12),
                        child:
                            Text("${list[7]["sets"]}", style: TextStyle(color: Colors.white)),
                      ),
                    ],
                  ),
                  Row(
          ...
          fontSize: 16.0);
                                                              Navigator.push(context, MaterialPageRoute(builder: (context) => w_plan2(w_plan2(h).email)));
