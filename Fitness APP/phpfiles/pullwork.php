...
");
 ...
 ");  
    $query11 =$con->query("SELECT * FROM graduationdb.`workout` WHERE   id =388");
...
");
    ...
    $query14 =$con->query("SELECT * FROM graduationdb.`workout` WHERE  id=424");
...
elseif($fitness_level>85){
    ...
    $query8 =$con->query("SELECT * FROM graduationdb.`workout` Where id=447
");
...
");
 ...
 ");  
    ...
    $query12 =$con->query("SELECT * FROM graduationdb.`workout` WHERE  id=1
");
    $query13 =$con->query("SELECT * FROM graduationdb.`workout` WHERE  id=39");
    $query14 =$con->query("SELECT * FROM graduationdb.`workout` WHERE  id=424");
...
$query1 =$con->query("SELECT * FROM `workout` WHERE  id=464");
$query2 =$con->query("SELECT * FROM graduationdb.workout where id=498
");
$query3 =$con->query("SELECT * FROM graduationdb.workout where id=47");
$query4 =$con->query("SELECT * FROM graduationdb.workout where id=1");
$query5 =$con->query("SELECT * FROM graduationdb.workout where id=881");
$query6 =$con->query("SELECT * FROM graduationdb.workout where id=247");
$query7 =$con->query("SELECT * FROM graduationdb.workout where id=800");
