...
if($fitness_level>85||($fitness_level % 2)==0){
    ...
    $query8 =$con->query("SELECT * FROM graduationdb.`workout` Where id=360
");
    $query9 =$con->query("SELECT * FROM graduationdb.`workout` WHERE  id=357
");
    $query10 =$con->query("SELECT * FROM graduationdb.`workout` WHERE  id=388
 ");  
    $query11 =$con->query("SELECT * FROM graduationdb.`workout` WHERE   id =367");
    $query12 =$con->query("SELECT * FROM graduationdb.`workout` WHERE  id=344
");
    $query13 =$con->query("SELECT * FROM graduationdb.`workout` WHERE  id=424");
...
elseif($fitness_level>85){
    ...
    $query8 =$con->query("SELECT * FROM graduationdb.`workout` Where id=357
");
    $query9 =$con->query("SELECT * FROM graduationdb.`workout` WHERE  id=360
");
    $query10 =$con->query("SELECT * FROM graduationdb.`workout` WHERE  id=388
 ");  
    $query11 =$con->query("SELECT * FROM graduationdb.`workout` WHERE   id =367");
...
$query1 =$con->query("SELECT * FROM `workout` WHERE id=262");
$query2 =$con->query("SELECT * FROM graduationdb.workout where id=336
");
$query3 =$con->query("SELECT * FROM graduationdb.workout where id=360");
$query4 =$con->query("SELECT * FROM graduationdb.workout where id=374");
$query5 =$con->query("SELECT * FROM graduationdb.workout where id=390");
$query6 =$con->query("SELECT * FROM graduationdb.workout where id=244");
