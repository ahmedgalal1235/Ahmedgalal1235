...
if($fitness_level>85||($fitness_level % 2)==0){
    ...
    $query8 =$con->query("SELECT * FROM graduationdb.`workout` Where id=149
");
    $query9 =$con->query("SELECT * FROM graduationdb.`workout` WHERE  id=160
");
    $query10 =$con->query("SELECT * FROM graduationdb.`workout` WHERE  id=161
 ");  
    $query11 =$con->query("SELECT * FROM graduationdb.`workout` WHERE   id =514");
    $query12 =$con->query("SELECT * FROM graduationdb.`workout` WHERE  id=571
");
    $query13 =$con->query("SELECT * FROM graduationdb.`workout` WHERE  id=767");
...
elseif($fitness_level>85){
    ...
    $query8 =$con->query("SELECT * FROM graduationdb.`workout` Where id=160
");
    $query9 =$con->query("SELECT * FROM graduationdb.`workout` WHERE  id=149
");
    $query10 =$con->query("SELECT * FROM graduationdb.`workout` WHERE  id=164
 ");  
    $query11 =$con->query("SELECT * FROM graduationdb.`workout` WHERE   id =571");
    $query12 =$con->query("SELECT * FROM graduationdb.`workout` WHERE  id=514
");
    $query13 =$con->query("SELECT * FROM graduationdb.`workout` WHERE  id=767");
    $query14 =$con->query("SELECT * FROM graduationdb.`workout` WHERE  id=775");
...
if($fitness_goal==1000){
    ...
    $query1 =$con->query("SELECT * FROM `workout` WHERE id=146");
    $query2 =$con->query("SELECT * FROM graduationdb.workout where id=160
    ");
    $query3 =$con->query("SELECT * FROM graduationdb.workout where id=177");
    $query4 =$con->query("SELECT * FROM graduationdb.workout where id=230");
    $query5 =$con->query("SELECT * FROM graduationdb.workout where id=520");
    $query6 =$con->query("SELECT * FROM graduationdb.workout where id=766");
