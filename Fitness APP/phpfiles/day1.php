...
if($fitness_level>85||($fitness_level % 2)==0){
    ...
    $query12 =$con->query("SELECT * FROM graduationdb.`workout` Where id=104");
...
");
 ...
 ");  
    $query11 =$con->query("SELECT * FROM graduationdb.`workout` WHERE   id =81");
...
if($fitness_goal==1000){
    ...
    $query7 =$con->query("SELECT * FROM graduationdb.`workout` WHERE  Category like'%Stretches%' limit 1 ");
    $query12 =$con->query("SELECT * FROM graduationdb.`workout` Where id=101");

    $query8 =$con->query("SELECT * FROM graduationdb.`workout` Where id=104");
    $query9 =$con->query("SELECT * FROM graduationdb.`workout` WHERE  id=67
");
    $query10 =$con->query("SELECT * FROM graduationdb.`workout` WHERE  id=70
 ");  
    $query11 =$con->query("SELECT * FROM graduationdb.`workout` WHERE   id =83");

    $query13 =$con->query("SELECT * FROM graduationdb.`workout` WHERE  id=302");
    $query14 =$con->query("SELECT * FROM graduationdb.`workout` WHERE  id=792");
...
$query1 =$con->query("SELECT * FROM `workout` WHERE  id= 69");
$query2 =$con->query("SELECT * FROM graduationdb.workout where id=81
");
$query3 =$con->query("SELECT * FROM graduationdb.workout where id=85");
$query4 =$con->query("SELECT * FROM graduationdb.workout where id=84");
$query5 =$con->query("SELECT * FROM graduationdb.workout where id=104");

$query6 =$con->query("SELECT * FROM graduationdb.workout where id=307");
